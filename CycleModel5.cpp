...
Matrice CycleModel5(Matrice Pop, double Ei, double mutD, double mutE, double mutA, double SigD, double SigE, double h, double S, double Rij, double Rjk, double Self, double I, int Npop, string FIT, string ALLELES)
{
    ...
    for(indPop = 0 ; indPop < Npop ; ++indPop)
    {
        ...
        {
            Vecteur Selec = SelectionModel5(Ei,DChrom1[indPop],EChrom1[indPop],SChrom1[indPop],DChrom2[indPop],EChrom2[indPop],SChrom2[indPop],h,I);
    ...
    Matrice Descendance(DCHROM1,ECHROM1,SCHROM1,DCHROM2,ECHROM2,SCHROM2,H,Empty,Empty,Empty);
